DROP DATABASE IF EXISTS `hotelList`;
CREATE DATABASE `hotelList` /*!40100 DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci */ /*!80016 DEFAULT ENCRYPTION='N' */;
USE `hotelList`;
...
-- Dump completed on 2019-05-25  3:11:01
